...
In order to support loading of multiple wallets in smm-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is smm.cpp.
...
Changes to smm.cpp
----------------------
smm.cpp is the entry point into smm-qt, and as such, will require some minor modifications to provide hooks for
