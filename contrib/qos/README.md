...
This means one can have an always-on smmd instance running, and another local smmd/smm-qt instance which connects to this node and receives blocks from it.
