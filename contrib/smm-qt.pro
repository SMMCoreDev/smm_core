...
RESOURCES += src/qt/smm.qrc src/qt/smm_locale.qrc

TRANSLATIONS += src/qt/locale/smm_bg.ts \
                src/qt/locale/smm_de.ts \
                src/qt/locale/smm_en.ts \
                src/qt/locale/smm_es.ts \
                src/qt/locale/smm_fi.ts \
                src/qt/locale/smm_fr.ts \
                src/qt/locale/smm_it.ts \
                src/qt/locale/smm_ja.ts \
                src/qt/locale/smm_pl.ts \
                src/qt/locale/smm_pt.ts \
                src/qt/locale/smm_ru.ts \
                src/qt/locale/smm_sk.ts \
                src/qt/locale/smm_sv.ts \
                src/qt/locale/smm_vi.ts \
                src/qt/locale/smm_zh_CN.ts \
                src/qt/locale/smm_zh_TW.ts
