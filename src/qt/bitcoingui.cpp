                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SMM Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    //TEST!!!
    statusBar()->setStyleSheet("border: 0");
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Smm address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and smm: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSMM"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SMM Core"), this);
    aboutAction->setStatusTip(tr("Show information about SMM Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Smm"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Smm addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Smm addresses"));
    ...
    openAction->setStatusTip(tr("Open a Smm: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SMM Core help message to get a list with possible Smm command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SMM Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Smm network", "", count));
}
...
{
    QString strTitle = tr("SMM Core"); // default title
