...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Smm features */
        {"smm", "masternode", &masternode, true, true, false},
        {"smm", "listmasternodes", &listmasternodes, true, true, false},
        {"smm", "getmasternodecount", &getmasternodecount, true, true, false},
        {"smm", "masternodeconnect", &masternodeconnect, true, true, false},
        {"smm", "masternodecurrent", &masternodecurrent, true, true, false},
        {"smm", "masternodedebug", &masternodedebug, true, true, false},
        {"smm", "startmasternode", &startmasternode, true, true, false},
        {"smm", "createmasternodekey", &createmasternodekey, true, true, false},
        {"smm", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"smm", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"smm", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"smm", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"smm", "getmasternodescores", &getmasternodescores, true, true, false},
        {"smm", "mnbudget", &mnbudget, true, true, false},
        {"smm", "preparebudget", &preparebudget, true, true, false},
        {"smm", "submitbudget", &submitbudget, true, true, false},
        {"smm", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"smm", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"smm", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"smm", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"smm", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"smm", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"smm", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"smm", "checkbudgets", &checkbudgets, true, true, false},
        {"smm", "mnsync", &mnsync, true, true, false},
        {"smm", "spork", &spork, true, true, false},
        {"smm", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"smm", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use smmd, or the -server option to smm-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> smm-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:18100/\n";
}
